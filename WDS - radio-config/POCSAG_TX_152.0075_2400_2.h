...
// RF Freq.(MHz): 152.0075    API_TC: 29    fhst: 35000    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 1    Hi_pfm_div: 1    
...
*/
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x3B, 0x0E, 0x6C, 0x8B, 0x1C, 0xAC, 0x20, 0xFA
